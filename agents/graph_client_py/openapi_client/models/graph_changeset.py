...
class GraphChangeset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nodes", "relationships"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": [GraphRelationship.from_dict(_item) for _item in obj["relationships"]] if obj.get("relationships") is not None else None
        })
        return _obj
